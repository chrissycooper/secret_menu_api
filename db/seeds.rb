...
menu1 = SecretMenuItem.create(menu_name: "Chipotle Nachoes", restaurant_name: "Chipotle", menu_description: "Build a plate of nachos with all your favorite fixings")
